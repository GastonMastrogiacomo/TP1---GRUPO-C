    ...
    public partial class PantallaPrincipal : Form
    {
        ...
        private void Btn_ComprarEntradas_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(this.Input_CantEntradas.Text, out int cantEntradas))
            {
                ...
                if (cine.ComprarEntrada(offset, cantEntradas))
                {
        ...
        private void dataGridFuncionesPpal_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
            //offset de el numero del ID

            int primerId = int.Parse(dataGridFuncionesPpal[0, 0].Value.ToString());
            int offset = e.RowIndex + primerId;

            MessageBox.Show("offset: " + offset);


            //idFuncionSeleccionada = int.Parse(dataGridFuncionesPpal[0, offset].Value.ToString());
